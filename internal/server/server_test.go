...
func TestSetupInitializeLoginAndGeneratedConfigs(t *testing.T) {
	...
	body := map[string]any{
		...
		"mihomo_proxies":       "vless://c20c7f96-e1a1-4203-bffa-888ef04959fd@example.com:443?encryption=none&security=reality&type=tcp&sni=example.invalid&fp=chrome&pbk=abc&sid=123&flow=xtls-rprx-vision#placeholder-node-1",
		"enableIPv6":           true,
